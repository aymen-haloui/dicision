            ...
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <SectionTitle>Données anthropométriques</SectionTitle>
                </div>
                ...
                {(formData.pregnancy_status === true || formData.pregnancy_status === 'true') && (
              ...
              <CardContent className="space-y-6">
                ...
                {formData.conditions.length === 0 && (
                  <div className="text-center py-8 text-slate-500">
                    Aucune condition chronique ajoutée.
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {formData.medications.length === 0 && (
                  <div className="text-center py-8 text-slate-500">
                    Aucun traitement chronique ajouté.
                  </div>
                )}
              </CardContent>
            </Card>
